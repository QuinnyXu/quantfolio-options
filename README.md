...
- A pick also needs a Buy / Buy-on-weakness verdict in the Quantfolio index (kept outside this repo) with the price at or below that name's `add_level`; only those names are fetched.
